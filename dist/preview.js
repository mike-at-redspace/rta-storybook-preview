...
var require_html2canvas = __commonJS({
  "node_modules/.pnpm/html2canvas@1.4.1/node_modules/html2canvas/dist/html2canvas.js"(exports$1, module) {
    (function(global, factory) {
      typeof exports$1 === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, global.html2canvas = factory());
    })(exports$1, (function() {
      ...
      function __spreadArray(to, from, pack2) {
        if (arguments.length === 2) for (var i2 = 0, l = from.length, ar; i2 < l; i2++) {
          if (ar || !(i2 in from)) {
      ...
      var FontMetrics = (
        ...
        (function() {
          ...
          FontMetrics2.prototype.getMetrics = function(fontFamily2, fontSize3) {
            var key = fontFamily2 + " " + fontSize3;
            if (typeof this._data[key] === "undefined") {
              this._data[key] = this.parseMetrics(fontFamily2, fontSize3);
            }
      ...
      var CanvasRenderer = (
        ...
        (function(_super) {
          ...
          CanvasRenderer2.prototype.renderTextNode = function(text, styles) {
            return __awaiter(this, void 0, void 0, function() {
              var _a, font, fontFamily2, fontSize3, _b, baseline, middle, paintOrder2;
              var _this = this;
              return __generator(this, function(_c) {
                _a = this.createFontStyle(styles), font = _a[0], fontFamily2 = _a[1], fontSize3 = _a[2];
                this.ctx.font = font;
                this.ctx.direction = styles.direction === 1 ? "rtl" : "ltr";
                this.ctx.textAlign = "left";
                this.ctx.textBaseline = "alphabetic";
                _b = this.fontMetrics.getMetrics(fontFamily2, fontSize3), baseline = _b.baseline, middle = _b.middle;
          ...
          CanvasRenderer2.prototype.renderNodeContent = function(paint) {
            return __awaiter(this, void 0, void 0, function() {
              var container, curves, styles, _i, _a, child, image2, image2, iframeRenderer, canvas, size, _b, fontFamily2, fontSize3, baseline, bounds, x, textBounds, img, image2, url, fontFamily2, bounds;
              return __generator(this, function(_c) {
                switch (_c.label) {
                  case 0:
                  ...
                  case 14:
                    ...
                    if (isTextInputElement(container) && container.value.length) {
                      _b = this.createFontStyle(styles), fontFamily2 = _b[0], fontSize3 = _b[1];
...
function useDebouncedResize(callback, delayMs, deps) {
...
function usePanWhenZoomed(isPanEnabled, deviceId, rotation, zoom) {
...
// src/lib/compute-scale.ts
function computeScale(viewportWidth, viewportHeight, zoom, containerWidth, containerHeight, fitMarginPx = 0) {
...
// src/lib/get-viewport-dimensions.ts
function getViewportDimensions(deviceId, customWidth, customHeight, rotation = 0) {
  let width;
  let height;
...
var STAGE_GRADIENT = "linear-gradient(135deg, #1a1a2e 0%, #16213e 50%, #0f3460 100%)";
function usePreviewViewport() {
  ...
  const effectiveRotation = device && !device.rotatable ? 0 : rotation;
  useEffect(() => {
    if (!enabled) return;
  ...
  const viewportTransform = useMemo(() => scale !== 1 ? `scale(${scale})` : void 0, [scale]);
  const deviceWrapperTransform = useMemo(
    () => canPan && (pan.x !== 0 || pan.y !== 0) ? `translate(${pan.x}px, ${pan.y}px)` : void 0,
    [canPan, pan.x, pan.y]
  );
  ...
  const deviceWrapperStyle = useMemo(
    () => ({
      position: "relative",
      display: "inline-flex",
  ...
  const dimensionsLabel = isConstrained ? `${viewportWidth} \xD7 ${viewportHeight}` : "\u2014";
  return {
    enabled,
    containerRef,
...
var THIN_SCROLLBAR_STYLE = /* @__PURE__ */ jsx(
  "style",
  {
...
// src/initial-globals.ts
var initialGlobals = {
  rtaPreviewEnabled: false,
  rtaPreviewToolbarVisible: false,
  rtaPreviewDevice: DEFAULT_DEVICE_ID,
  rtaPreviewRotate: DEFAULT_ROTATION,
  rtaPreviewZoom: DEFAULT_ZOOM,
  rtaPreviewCustomWidth: void 0,
  rtaPreviewCustomHeight: void 0
};
function getRtaPreviewPreviewConfig() {
  return {
    initialGlobals: { ...initialGlobals },
    globals: { ...initialGlobals }
  };
}
function PreviewView({ viewport: v, children }) {
  ...
  useEffect(() => {
    ...
    const handler = (payload) => {
      ...
      (0, import_html2canvas.default)(element, { useCORS: true }).then((canvas) => {
        canvas.toBlob((blob) => {
          if (!blob) return;
  ...
  const viewport = /* @__PURE__ */ jsx("div", { style: v.viewportStyle, className: "rta-preview-viewport", children });
  const scaledWrapperStyle = v.isConstrained && v.scaledWidth > 0 && v.scaledHeight > 0 ? {
    width: v.scaledWidth,
  ...
  const content = v.isConstrained && v.scaledWidth > 0 && v.scaledHeight > 0 ? /* @__PURE__ */ jsx("div", { style: scaledWrapperStyle, className: "rta-preview-scaled-wrapper", children: viewport }) : viewport;
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { style: v.deviceWrapperStyle, children: [
          v.showFrame && v.isConstrained ? /* @__PURE__ */ jsx("div", { style: FRAME_STYLE, className: "rta-preview-device-frame", children: content }) : content,
          v.showSize && v.isConstrained && /* @__PURE__ */ jsx(
            "output",
            {
              style: SIZE_OVERLAY_STYLE,
              "aria-live": "polite",
              "aria-label": `Viewport dimensions: ${v.dimensionsLabel}`,
              children: v.dimensionsLabel
            }
          )
        ] })
      ]
...
function Preview({ children }) {
  ...
  return /* @__PURE__ */ jsx(PreviewView, { viewport, children });
}
var withRtaPreview = (Story, context) => {
  const viewport = usePreviewViewport();
  if (context?.viewMode === "docs") {
    return /* @__PURE__ */ jsx(Story, {});
  }
  return /* @__PURE__ */ jsx(PreviewView, { viewport, children: /* @__PURE__ */ jsx(Story, {}) });
};
...
export { Preview, Preview as RtaPreviewDecorator, getRtaPreviewPreviewConfig, initialGlobals, withRtaPreview };
