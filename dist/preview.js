...
function usePanWhenZoomed(isPanEnabled, deviceId, rotation, zoom) {
  const [pan, setPan] = useState2({ x: 0, y: 0 });
  const [isDragging, setIsDragging] = useState2(false);
  const lastClientRef = useRef3({ x: 0, y: 0 });
  const pointerIdRef = useRef3(null);
  ...
  const handlePointerDown = useCallback2(
    (e2) => {
      if (!isPanEnabled || e2.button !== 0) return;
      e2.preventDefault();
      const target = e2.currentTarget;
      pointerIdRef.current = e2.pointerId;
      target.setPointerCapture(e2.pointerId);
      lastClientRef.current = { x: e2.clientX, y: e2.clientY };
      setIsDragging(true);
      const onMove = (ev) => {
...
var fontSize2 = (theme) => theme.typography?.size?.s2 ?? 12;
...
function PreviewView({ viewport: v, children }) {
  const containerRefRef = useRef5(v.containerRef);
  const enabledRef = useRef5(v.enabled);
  ...
  useEffect6(() => {
    ...
    const handler = (payload) => {
      ...
      html2canvas_esm_default(element, { useCORS: true }).then((canvas) => {
        canvas.toBlob((blob) => {
          if (!blob) return;
  ...
  const viewport = /* @__PURE__ */ jsx2("div", { style: v.viewportStyle, className: "rta-preview-viewport", children });
  ...
  const content2 = v.isConstrained && v.scaledWidth > 0 && v.scaledHeight > 0 ? /* @__PURE__ */ jsx2("div", { style: scaledWrapperStyle, className: "rta-preview-scaled-wrapper", children: viewport }) : viewport;
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { style: v.deviceWrapperStyle, children: [
          v.showFrame && v.isConstrained ? /* @__PURE__ */ jsx2("div", { style: FRAME_STYLE, className: "rta-preview-device-frame", children: content2 }) : content2,
          v.showSize && v.isConstrained && /* @__PURE__ */ jsx2(
            "output",
            {
...
function Preview({ children }) {
  ...
  return /* @__PURE__ */ jsx2(PreviewView, { viewport, children });
}
var withRtaPreview = (Story, context) => {
  const viewport = usePreviewViewport();
  if (context?.viewMode === "docs") {
    return /* @__PURE__ */ jsx2(Story, {});
  }
  return /* @__PURE__ */ jsx2(PreviewView, { viewport, children: /* @__PURE__ */ jsx2(Story, {}) });
};
export {
  Preview,
  Preview as RtaPreviewDecorator,
